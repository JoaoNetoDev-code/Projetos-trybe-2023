const clients = [
  ...
  const findPersonByName = (name) => {
    ...
    try {
        ...
        const Destinatário = `Destinatário: ${person.name}.`;
        const Endereço = `Endereço: ${person.address.street}, ${person.address.number}, ${person.address.neighborhood}, ${person.address.city} - ${person.address.state}.`
        const cep =`CEP: ${person.address.cep}`
        return `${Destinatário}. ${Endereço}. ${cep}.`
    }
